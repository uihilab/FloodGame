...
import { createMeshes } from "./loadModels.js?v=22";
    ...
    function createWorld() {
        ...
        for (var r = 0; r < numberOfRows; r++) {
            for (var c = 0; c < numberOfColumns; c++) {
                ...
                // Build underplate quad at elevation - 2.0
                var uy = obj.elevation - 2.0;
                verticesUnder.push(x0, uy, z0);
                verticesUnder.push(x1, uy, z0);
                verticesUnder.push(x2, uy, z2);
                verticesUnder.push(x3, uy, z3);
