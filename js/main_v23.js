...
import { createMeshes } from "./loadModels.js?v=23";
    ...
    function createWorld() {
        ...
        for (var r = 0; r < numberOfRows; r++) {
            for (var c = 0; c < numberOfColumns; c++) {
                ...
                // Build parallel underplate quad at elevation - 2.5
                verticesUnder.push(x0, y0 - 2.5, z0);
                verticesUnder.push(x1, y1 - 2.5, z0);
                verticesUnder.push(x2, y2 - 2.5, z2);
                verticesUnder.push(x3, y3 - 2.5, z2);
