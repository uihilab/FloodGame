...
import { createMeshes } from "./loadModels.js?v=28";
                        ...
                        for (var d = 0; d < dirs.length; d++) {
                            ...
                            if (nr >= 0 && nr < numberOfRows && nc >= 0 && nc < numberOfColumns) {
                                if (surfaceTiles[nr][nc] === 0 && surfaceTiles_v2[nr][nc] === 0 && groundTiles[nr][nc].type === "parks") {
                                    ...
                                    surfaceTiles_v2[nr][nc] = { "type": "parking", "instanceId": [] };
            ...
            for (var column = 0; column < numberOfColumns; column++){
                ...
                if (obj != 0){
                    ...
                    if (obj.type == "tree"){
                        ...
                        var roadY1 = y0 * (1 - u1) * (1 - v1) + y1 * u1 * (1 - v1) + y2 * (1 - u1) * v1 + y3 * u1 * v1 + 0.45;
                        ...
                        var roadY2 = y0 * (1 - u2) * (1 - v2) + y1 * u2 * (1 - v2) + y2 * (1 - u2) * v2 + y3 * u2 * v2 + 0.45;
